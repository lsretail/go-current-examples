...
function Install-Package($Context)
{
    ...
    Write-Progress -Id 217 -Activity "Installing Git" -Status "Running installer..."
    ...
    Write-Progress -Id 217 -Activity "Installing Git" -Status "Done!"
}

function Remove-Package($Context)
{
    Write-Progress -Id 217 -Activity "Removing Git" -Status "Removing..."
